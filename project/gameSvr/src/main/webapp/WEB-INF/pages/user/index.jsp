...
<script type="text/javascript" src="${ctx}/resource/js/typeahead-bs2.min.js"></script>

<!-- page specific plugin scripts -->

<!--[if lte IE 8]>
<script type="text/javascript" src="${ctx}/resource/js/excanvas.min.js"></script>
<![endif]-->

<script type="text/javascript" src="${ctx}/resource/js/jquery-ui-1.10.3.custom.min.js"></script>
<script type="text/javascript" src="${ctx}/resource/js/jquery.ui.touch-punch.min.js"></script>
<script type="text/javascript" src="${ctx}/resource/js/jquery.gritter.min.js"></script>
<script type="text/javascript" src="${ctx}/resource/js/bootbox.min.js"></script>
<script type="text/javascript" src="${ctx}/resource/js/jquery.slimscroll.min.js"></script>
<script type="text/javascript" src="${ctx}/resource/js/jquery.easy-pie-chart.min.js"></script>
<script type="text/javascript" src="${ctx}/resource/js/jquery.hotkeys.min.js"></script>
<script type="text/javascript" src="${ctx}/resource/js/bootstrap-wysiwyg.min.js"></script>
<script type="text/javascript" src="${ctx}/resource/js/select2.min.js"></script>
<script type="text/javascript" src="${ctx}/resource/js/date-time/bootstrap-datepicker.min.js"></script>
<script type="text/javascript" src="${ctx}/resource/js/fuelux/fuelux.spinner.min.js"></script>
<script type="text/javascript" src="${ctx}/resource/js/x-editable/bootstrap-editable.min.js"></script>
<script type="text/javascript" src="${ctx}/resource/js/x-editable/ace-editable.min.js"></script>
<script type="text/javascript" src="${ctx}/resource/js/jquery.maskedinput.min.js"></script>
